import { deleteEmployee, getEmployee, getSearchData } from '@/Services/employee/employee.service';
                        ...
                        <div className="card">
                            <div className="card-header">
                                <div className='d-flex justify-content-between align-items-center'>
                                    ...
                                    <div>
                                        <Link className='btn btn-outline-primary btn-sm' href={"/admin/employee/create"}> <FontAwesomeIcon icon={faPenToSquare} />  Add Employee</Link>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                data.data != undefined && data.data.map((da, index) => {
                                                    ...
                                                    return (
                                                        <tr key={index}>
                                                            ...
                                                            <td>
                                                                <Link href={`employee/edit/${da.id}`} className='btn btn-sm me-3 btn-success'> <FontAwesomeIcon icon={faPen} /> </Link>
                                                                <Link href={`employee/details/${da.id}`} className='btn btn-sm me-3 btn-primary'> <FontAwesomeIcon icon={faEye} /> </Link>
                                                                <Button
