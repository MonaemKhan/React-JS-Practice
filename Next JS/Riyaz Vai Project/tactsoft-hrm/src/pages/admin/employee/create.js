...
import { getAllCountry, getCityByState, getStateByCountry } from '@/Services/common/common.service';
...
const CreateEmployee = () => {
    ...
    const handleChange = (e) => {
        const { name, value, type, files } = e.target; //distructure
        setFormData((prevData) => ({
            ...prevData,
            [name]: value, // array notation
        }));
        if (type === 'file') {
                                ...
                                <div className="row mt-2">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div className="row mb-2">
                                            ...
                                            <div className="col-md-9">
                                                <select onChange={(e) => loadState(e)} className="form-control"   name="countryId">
                                                ...
                                                {imagePreviewUrl !== "" ?
                                                    <div className="mt-3 text-end">
                                                        <img
                                                            ...
                                                            style={{ width: "150px" }}
                                                        />
                                                    </div> : <> <img src={`/image/boxed-bg.jpg`} alt="hi" style={{ width: "155px" }} /> </>
                                                }
                                            </div>
                                        </div>
                                    </div>
